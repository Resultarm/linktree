...
const appTheme = (color, mode) => ({
  ...
  overrides: {
    PrivateTabIndicator: {
      ...
      colorPrimary: {
        backgroundColor: mode === 'dark' ? palette_default.a[color].palette.primary.light : palette_default.a[color].palette.primary.main
      }
    },
    MuiPaper: {
      rounded: {
...
function MyApp(props) {
  ...
  const {
    0: theme,
    1: setTheme
  } = Object(external_react_["useState"])(_objectSpread(_objectSpread({}, theme_appTheme('violeta', themeType)), {}, {
  ...
  const toggleDarkTheme = () => {
    ...
    setTheme(_objectSpread(_objectSpread({}, theme_appTheme('violeta', newPaletteType)), {}, {
