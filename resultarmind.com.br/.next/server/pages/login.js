...
function Login(props) {
  ...
  }, t('common:login')), __jsx(Button_default.a, {
    size: "small",
  ...
  }, "arrow_forward"), t('common:login_create'))), __jsx(SocialAuth["a" /* default */], null), __jsx("div", {
    className: classes.separator
  }, __jsx(Typography_default.a, null, t('common:login_or'))), __jsx(external_react_material_ui_form_validator_["ValidatorForm"], {
...
/* harmony default export */ var Forms_Login = (Object(i18n["withTranslation"])(['common'])(Login));
...
function login_Login() {
  return login_jsx(external_react_["Fragment"], null, login_jsx(head_default.a, null, login_jsx("title", null, brand_default.a.saas.name, "\xA0 - Login")), login_jsx("div", null, login_jsx(Forms_Login, null)));
}

login_Login.getInitialProps = async () => ({
